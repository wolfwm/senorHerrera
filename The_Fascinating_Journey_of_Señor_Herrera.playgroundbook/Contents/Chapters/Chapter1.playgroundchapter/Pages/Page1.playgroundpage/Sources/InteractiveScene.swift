...
public class SmithingViewController : UIViewController {
    ...
    override public func loadView() {
        ...
        //        label.frame = CGRect(x: screenWidth / 2 - (herreraView.frame.width * 5 / 2), y: screenHeight * 4 / 5, width: herreraView.frame.width * 5, height: herreraView.frame.width * 1.1)
        ...
        label.text = "This is Señor Herrera!"
